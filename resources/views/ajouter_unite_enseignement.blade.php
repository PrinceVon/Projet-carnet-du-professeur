...
@section('content')
    <div class="card">
        <div class="container mt-5">
            <h1 class="text-center mb-4">Ajouter une Unité d'Enseignement</h1>
        
            <form id="uniteForm" method="POST" action="{{ route('ajouter.unite_enseignement.store') }}" class="form-group">
                @csrf
