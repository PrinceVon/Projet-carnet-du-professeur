  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      @if(Auth::user()->role === 'professeur')
        <li class="nav-item">
          <a class="nav-link {{ Request::is('ajouter*') ? 'active' : '' }}" href="#" id="navbarLink">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="card">
            <ul class="submenu px-2 py-3">
              <li><i class="fas fa-plus" style="color: #282e77;"></i><a class="submenu-item" href="{{ url('/ajouter/annee-scolaire') }}" style="color: black;"> <b>Année scolaire</b></a></li>
              <li><i class="fas fa-plus" style="color: #282e77;"></i><a class="submenu-item" href="{{ url('/ajouter/institution') }}" style="color: black;"> <b>Institutions</b></a></li>
              <li><i class="fas fa-plus" style="color: #282e77;"></i><a class="submenu-item" href="{{ url('/ajouter/unite-enseignement') }}" style="color: black;"> <b>Unités d'enseignement</b></a></li>
              <li><i class="fas fa-plus" style="color: #282e77;"></i><a class="submenu-item" href="{{ url('/ajouter/filiere') }}" style="color: black;"> <b>Filières</b></a></li>
              <li><i class="fas fa-plus" style="color: #282e77;"></i><a class="submenu-item" href="{{ url('/ajouter/salle') }}" style="color: black;"> <b>Salles</b></a></li>
            </ul>
          </div>
