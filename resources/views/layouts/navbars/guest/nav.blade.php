  ...
  <div class="container-fluid {{ (Request::is('static-sign-up') ? 'container' : 'container-fluid') }}">
    ...
    <div class="collapse navbar-collapse" id="navigation">
      ...
      <ul class="navbar-nav d-lg-block d-none">
        <li class="nav-item">
          <a href="{{ auth()->user() ? url('static-sign-up') : url('register') }}" target="_blank" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-{{ (Request::is('static-sign-up') ? 'light' : 'dark') }}">S'inscrire</a>
        </li>
      </ul>
      <ul class="navbar-nav d-lg-block d-none">
        <li class="nav-item">
          <a href="{{ auth()->user() ? url('static-sign-up') : url('login') }}" target="_blank" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-{{ (Request::is('static-sign-in') ? 'light' : 'dark') }}">Se connecter</a>
        </li>
      </ul>
    </div>
  </div>
